...
All backend API calls go through: http://localhost:5000
...
accurate_pct = (accurate_count / total_claims _ 100).toFixed(1) + "%"
false_pct = (false_count / total_claims _ 100).toFixed(1) + "%"

...
function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // In plain HTML, forms reload the page. In React, we handle it in JS instead.
    e.preventDefault();
    setError("");
    setLoading(true);
    try {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4">
      ...
      >
        ...
        <p className="text-slate-400 mb-8">Sign in to verify economic claims</p>

        {/* Error banner — only shows when error state is non-empty */}
        {error && (
          <motion.div
        ...
        {/* 
          The <form> wraps our inputs. When the user presses Enter or clicks
          the submit button, onSubmit fires. This is standard HTML behavior
          that React hooks into.
        */}
